    ...
    <header className="bg-surface-container/80 backdrop-blur-md sticky top-0 z-50 border-b border-outline-variant/30 w-full">
      <nav className="flex justify-between items-center w-full px-lg py-sm max-w-container-max mx-auto">
        ...
        <div className="flex items-center gap-sm">
          ...
          <Link
            to="/signin"
            className="px-md py-xs bg-gradient-to-r from-primary-container to-secondary-container text-on-primary-container rounded-lg font-label-xs text-label-xs font-bold hover:brightness-110 active:scale-95 transition-all"
          >
            Sign In
          </Link>
        </div>
